...
class App extends Didact.Component {
  render() {
    return Didact.createElement("div", null, Didact.createElement("h1", null, "Didact Stories"), Didact.createElement("ul", null, this.props.stories.map(story => {
...
class Story extends Didact.Component {
  ...
  render() {
    ...
    return Didact.createElement("li", null, Didact.createElement("button", {
      onClick: e => this.like()
    }, likes, Didact.createElement("b", null, "\u2764\uFE0F")), Didact.createElement("a", {
      href: url
    }, name));
  }
}
